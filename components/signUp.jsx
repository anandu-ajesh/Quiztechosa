...
const SignUp = ({auth}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const success = await (data?.message)?.includes('User Created')
    if(success){
    ...
    <div className="mx-auto max-w-screen-2xl px-8  sm:px-12 lg:px-16">
      <div className="mx-auto max-w-2xl">
        ...
        <form action="#" className="mb-0 mt-12 space-y-6 rounded-lg p-8 shadow-lg sm:p-12 lg:p-16">
          <p className="text-center text-xl font-medium">Sign up to your account</p>
          ...
          <div className="text-center text-lg text-gray-500">
            <p className=" cursor-pointer" onClick={auth} >already have an account? Sign in</p>
          </div>
        </form>
      </div>
    </div>
